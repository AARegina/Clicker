...
function render_boost(parent, boost) {
    ...
    if (boost.boost_type === 1) {
        div.innerHTML = `
                <div class="item-1">
                    <input id="buy_img" type="image" style="height: 145px; width: 150px; border-radius: 20px" src="https://sun9-45.userapi.com/impg/6-oFudSJJYlaYG_fPsKrljvCZjELSO8PK9PAYA/TIjOvifIGNE.jpg?size=899x882&quality=96&sign=c4eb7ec00be517e70b533b9e437ed98f&type=album" alt=""/>
                </div>
                <div class="item-2">
                    <div class="box-1">
                       <div>Сила буста
  ...
  `
        ...
        div.innerHTML = `
                <div class="item-1">
                    <input id="buy_img" class="buy_img" type="image" style="height: 145px; width: 150px;" src="https://sun9-3.userapi.com/impg/Coi-VGqKSoynN5tOBBCbpFYbQsCpUFM3NtEDsQ/0NeCx-ZD9oo.jpg?size=900x1600&quality=96&sign=8e42068a8ce7a06f40dccfbb40547171&type=album"
                           "/>
                </div>
                <div class="item-2">
                    <div class="box-1">
